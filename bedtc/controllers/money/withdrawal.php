                                				...
                                				<div class="conditions">
                                					<div class="conditions-content">
                                					    <div class="conditions-list">
                                					        <div class="conditions-success">'.$_txt['withdraw_print'].'</div>
                            					            <div class="button" data-navigation data-href="home" data-template="main_inner"><span>'.$_txt['withdraw_print_gohome'].'</span></div>
                                					    </div>
                                					</div>
                                				</div>
    									    </div>
