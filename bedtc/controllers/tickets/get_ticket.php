        ...
        <div class="content">
			...
			<div class="appeal">
                <div class="appeal-title">
                    ...
                    <span class="appeal-title__text"><?= $_txt['appeal']; ?> <?= $ticket_info['id']; ?>/<?= $ticket_info['date']; ?></span>
                </div>
                <div class="appeal-content">
                    <div class="appeal-list">
                        <div class="appeal-item"><?= $_txt['appeal-theme']; ?>: <span class="appeal-item__text"><?= $ticket_info['subject']; ?></span></div>
                        <div class="appeal-item"><?= $_txt['appeal-status']; ?>:  <span class="appeal-item__text color"><?= $status; ?></span></div>
                        <div class="appeal-item"><?= $_txt['appeal-created']; ?>:  <span class="appeal-item__text"><?= date('d.m.y H:i', $ticket_info['date']); ?></span></div>
                    </div>
                </div>
            </div>
					...
					<div class="chat-window">
						...
						<div class="chat-list">
							<?php
								...
								<div class="chat-item <?= $current_user; ?>">
									...
									<div class="chat-item__date"><?= date('d.m.y H:i', $message['date']); ?></div>
								</div>
						<?php
								if ($message['is_answer'] == 1) {
									$last_sender = 3;
						...
						?>
								<form class="chat-form form-add" data-controller="tickets/add_message" data-callback="add-ticket-message">

									<div class="form-item">
										<textarea name="text" id="textarea" placeholder="Введите ваше сообщение" required ></textarea>
									</div>

									<button type="submit" class="button"><?= $_txt['appeal-send']; ?></button>

									<button type="submit" class="button-phone">
