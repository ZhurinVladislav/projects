...
$tasks_forum = tasks_get_list($user->id, 'quest_forum', $new_page, 15);

if ($tasks_forum != 'empty') {
?>
<div class="table__body">
	<div class="table__table">
		...
		<?php
			foreach ($tasks_forum['items'] as $item) {
...
<div class="pagination" data-controller="quests/get_list_forum" data-result="tasks_result">
<?php
	$pagination = $tasks_forum['pagination'];
