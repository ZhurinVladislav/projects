<?php
	global $root_url, $site_name, $user;
?>
<!DOCTYPE html>
...
<head>
	...
	<meta name="theme-color" content="#0197db">
	<meta name="msapplication-navbutton-color" content="#0197db">
	<meta name="apple-mobile-web-app-status-bar-style" content="#0197db">
