		...
		<div class="wrapper">
			...
			<div class="content">
				...
				<?php
					if ($user->is_logged()) {
				?>
						<a href="home" class="button-small user-icon">
							<span class="bg"></span>
						...
						<div class="settings">
							<a href="personal-data" class="button-small pink">
								<span class="bg"></span>
								<span class="bd-top"></span>
								<span class="bd-bottom"></span>
								<span class="bd-left"></span>
								<span class="bd-right"></span>
								<span class="caption">
									<img src="/app/images/icons/settings.svg">
								</span>
							</a>
						</div>
				...
				?>
						<a class="button-small blue registration" href="registration">
							<span class="bg"></span>
							<span class="bd-top"></span>
							<span class="bd-bottom"></span>
							<span class="bd-left"></span>
							<span class="bd-right"></span>
							<span class="caption">Регистрация</span>
						</a>
						<a class="button-small pink login" href="login">
							<span class="bg"></span>
							<span class="bd-top"></span>
							<span class="bd-bottom"></span>
							<span class="bd-left"></span>
							<span class="bd-right"></span>
							<span class="caption">
								<img src="/app/images/icons/user.svg">
								<span>Вход</span>
							</span>
						</a>
				<?php
