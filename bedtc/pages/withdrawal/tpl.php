...
?>
	...
	<section class="account-withdraw" data-placeholder="withdrawal-confirm">
		<div class="container">
			<div class="content">
				<h1 class="header_1"><?= $_txt['header']; ?></h1>
				<div class="conditions">
					<div class="conditions-title">
						<span class="conditions-title__icon">
							<svg><use xlink:href="/app/images/svg_sprite.svg#conditions"></use></svg>
						</span>
						<span class="conditions-title__text"><?= $_txt['conditions_header']; ?></span>
					</div>
					<div class="conditions-content">
						<div class="conditions-list">
							<div class="conditions-item">
								<?= $_txt['conditions_item_1']; ?>
							</div>
							<div class="conditions-item">
								<?= $_txt['conditions_item_2']; ?>
							</div>
							<div class="conditions-item">
								<?= $_txt['conditions_item_3']; ?>
							</div>
							<div class="conditions-item">
								<?= $_txt['conditions_item_4']; ?>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="withdraw">
					<div class="withdraw-title">
						<span class="withdraw-title__icon">
							<svg><use xlink:href="/app/images/svg_sprite.svg#withdraw"></use></svg>
						</span>
						<span class="withdraw-title__text"><?= $_txt['header']; ?></span>
					</div>
					<div class="withdraw-content">
						...
						<form class="form-add money__form" data-controller="money/withdrawal" data-callback="place_content" data-result="withdrawal-confirm">
							...
							<div class="withdraw-content__title"><?= $_txt['form']['title_1']; ?></div>

							<div class="money__form-paymethod_items withdraw-list" id="withdrawal">

								<label class="withdraw-item active">
                                ...
                                <!--
								<label class="withdraw-item">
									<img src="/app/images/payment2.svg" alt="">
									<input type="radio" style="display: none;" name="payment_system" value="qiwi">
								</label>
								-->

								<label class="withdraw-item">
									<img src="/app/images/payment6.svg" alt="">
							...
							<div class="form-item-wrap">
								...
								<div class="form-item">
									...
									<div class="input-wrap input_errors" data-error="">
							...
							<div class="checkboxs currencys">
								<div class="checkbox-wrap currencys_item active">
									<label>
										<input type="radio" name="currency" id="currency-usd" value="USD" checked >
								...
								<div class="checkbox-wrap currencys_item active" id="currency-rub">
									<label>
										<input type="radio" name="currency" value="RUB" id="ruble" checked>
										<div class="custom-checkbox">
											<svg><use xlink:href="/app/images/svg_sprite.svg#check"></use></svg>
										</div>
									</label>
							...
							<div class="withdraw-content__title"><?= $_txt['desc']['paymethod']; ?><span class="color"> PAYEER</span></div>

							<div class="withdraw-block__list">
								<div class="withdraw-block__item">payeer <?= $_txt['desc']['wallet']; ?>;</div>
								<div class="withdraw-block__item"><span class="color"><?= $_txt['desc']['commission']; ?>:</span> 5 %;</div>
								<div class="withdraw-block__item">
									<span class="color">
										<?= $_txt['desc']['rate']; ?>:
									</span> 
									1 <?= $coin; ?> = 
								...
								<div class="withdraw-block__item"><?= $_txt['desc']['btc_commis']; ?></div>
							</div>

							<div class="withdraw-form__list">
								<div class="withdraw-form__item">
									<div class="withdraw-form__sub"><?= $_txt['form']['total']; ?>:</div>
									<div class="withdraw-form__title">
							...
							<div class="form-item">
								...
								<div class="input-wrap input_errors" data-error="wrong_pin">
									<input type="text" class="default" name="pin" id="pin" placeholder="<?= $_txt['form']['pin_placeholder']; ?>" required>
									<div class="error-message" data-error-text="wrong_pin"></div>
								</div>
							</div>

							<button class="button" type="submit"><span><?= $_txt['form']['btn']; ?></span></button>
	...
	<div data-placeholder="withdrawal-confirm">
		...
		<form class="form-add money__form" data-controller="money/withdrawal" data-callback="place_content" data-result="withdrawal-confirm">
			...
			<div class="text-with-coin small">
				<?= $_txt['form_header']['title_1']; ?>
				<a data-href="tickets" data-template="main_external">
					<?= $_txt['form_header']['link']; ?>
				</a> 
				<?= $_txt['form_header']['title_2']; ?></div>
