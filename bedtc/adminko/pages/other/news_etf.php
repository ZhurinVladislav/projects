...
if ($_POST['action'] != 'get_page') {
	if ($_POST['action'] == 'add') {
		...
		if (news_etf_add_item($title_ru, $title_en, $title_de, $title_pt, $title_es, $title_fr, $title_hi, $title_id, $title_th, $title_tr, $title_zh, $annotation_ru, $annotation_en, $annotation_de, $annotation_pt, $annotation_es, $annotation_fr, $annotation_hi, $annotation_id, $annotation_th, $annotation_tr, $annotation_zh, $content_ru, $content_en, $content_de, $content_pt, $content_es, $content_fr, $content_hi, $content_id, $content_th, $content_tr, $content_zh, $image, $admin_only)) {
	...
	$get_new_id = $pdo->query('SELECT id FROM news_etf ORDER BY id DESC LIMIT 1');
	$new_id = $get_new_id->fetch();
	$new_id = $new_id['id'] + 1;
?>

<form class="form-default form-add" data-page-handler="other/news_etf">
	...
	<div class="form-hidden-section">
		<div class="form-item form-item-item">
			<label>
				...
				<input class="form-item__input" type="file" name="image" data-save-path="images/news-etf" data-id="<?= $new_id; ?>">
		...
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_ru" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_en" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_de" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_pt" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_es" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_fr" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_hi" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_id" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_th" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_tr" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
			<label>
				...
				<textarea name="annotation_zh" class="form-item__input"></textarea>
				<span class="form-item__description"></span>
			</label>
		</div>
		<div class="form-item form-item-text">
