...
export const fontsStyle = () => {
  ...
  let fontsFile = `${app.path.srcFolder}/sass/common/fonts.sass`;
  ...
  fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
    if (fontsFiles) {
      ...
      if (!fs.existsSync(fontsFile)) {
        ...
        console.log('Файл sass/general/fonts.sass уже существует. Для обновления файла его удалить!');
      }
    } else {
      // Если шрифтов нет
