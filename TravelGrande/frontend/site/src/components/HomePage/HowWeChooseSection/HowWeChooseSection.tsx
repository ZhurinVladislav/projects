      ...
      <div className="container">
        ...
        <div className="flex items-stretch gap-7.25 max-lg:flex-col">
          {steps.map((step, index) => (
            <AnimateOnView key={step.id} animation="fade-in-up" delay={200 + index * 100} className="flex flex-1 flex-col justify-center gap-2.5 overflow-hidden rounded border border-(--border-color) bg-white p-8 max-md:p-6">
