...
interface CityGuideSliderProps {
  cityName: string;
  subtitle: string;
  items: GuideItem[];
}

const CityGuideSlider = ({ cityName, subtitle, items }: CityGuideSliderProps) => {
      ...
      <div className="container">
        <div className="mb-16 flex flex-col items-center justify-center gap-6 text-center">
          <h2 className="font-[--font-primary] text-[40px] text-(--text-color) uppercase max-md:text-3xl max-sm:text-2xl">
            Гид по <span className="color">{cityName}</span>
          </h2>
...
export default CityGuideSlider;
