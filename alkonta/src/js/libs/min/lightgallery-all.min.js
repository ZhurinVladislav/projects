    ...
    (b.prototype.init = function () {
      ...
      (b.prototype.addHtml = function (b) {
        ...
        '.lg-sub-html' === this.s.appendSubHtmlTo
          ...
          'undefined' != typeof e &&
            null !== e &&
            ('' === e ? this.$outer.find(this.s.appendSubHtmlTo).addClass('lg-empty-html') : this.$outer.find(this.s.appendSubHtmlTo).removeClass('lg-empty-html')),
    ...
    !(function () {
      ...
      (c.prototype.init = function () {
          ...
          a.core.$outer.find('.lg-thumb').on('touchstart.lg', function (c) {
            ...
            a.core.$outer.find('.lg-thumb').on('touchend.lg', function () {
              a.thumbTotalWidth > a.thumbOuterWidth && d
                ? ((d = !1), a.$thumbOuter.removeClass('lg-dragging'), Math.abs(c - b) < a.core.s.swipeThreshold && (a.thumbClickable = !0), (a.left = e))
                : (a.thumbClickable = !0);
            });
        }),
        ...
        (c.prototype.destroy = function () {
          this.core.s.thumbnail &&
            this.core.$items.length > 1 &&
            (a(window).off('resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb'), this.$thumbOuter.remove(), this.core.$outer.removeClass('lg-has-thumb'));
        }),
              ...
              if (a.core.$outer.hasClass('lg-zoomed')) {
                ...
                g.preventDefault(),
                  ...
                  (Math.abs(c.x - b.x) > 15 || Math.abs(c.y - b.y) > 15) &&
                    (a.core.s.useLeftForZoom ? j.css({ left: h + 'px', top: i + 'px' }) : j.css('transform', 'translate3d(' + h + 'px, ' + i + 'px, 0)'));
              }
            }),
      ...
      (c.prototype.init = function () {
        ...
        c.core.$el.on('onAfterSlide.lg.tm', function (a, b, d) {
          history.replaceState
            ? history.replaceState(null, null, window.location.pathname + '#lg=' + c.core.s.galleryId + '&slide=' + d)
            ...
            setTimeout(function () {
              a('#lg-share-facebook').attr('href', 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(b.getSahreProps(e, 'facebookShareUrl') || window.location.href)),
                a('#lg-share-twitter').attr(
                  'href',
                  'https://twitter.com/intent/tweet?text=' + b.getSahreProps(e, 'tweetText') + '&url=' + encodeURIComponent(b.getSahreProps(e, 'twitterShareUrl') || window.location.href)
                ),
