...
$tasks_bug = tasks_get_list($user->id, 'quest_bug', $new_page, 15);
...
<div class="table__body">
	<div class="table__table">
		...
		<?php
			foreach ($tasks_bug['items'] as $item) {
		...
		?>
				<div class="table__table-item">
					...
					<div style="width: 70%"><?= $item['message'] ?></div>
...
<div class="pagination" data-controller="quests/get_list_bugs" data-result="tasks_result">
<?php
	$pagination = $tasks_bug['pagination'];
	if ($pagination != 'empty') {
