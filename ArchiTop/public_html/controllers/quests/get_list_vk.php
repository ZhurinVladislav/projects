...
$tasks_vk = tasks_get_list($user->id, 'quest_vk_repost', $new_page, 15);
...
<div class="table__body">
	<div class="table__table">
		...
		<?php
			foreach ($tasks_vk['items'] as $item) {
		...
		?>
				<div class="table__table-item">
					...
					<div style="width: 70%">
						<a href="<?= $item['link_sended'] ?>" target="_blank"><?= $item['link_sended'] ?></a>
					</div>
...
<div class="pagination" data-controller="quests/get_list_vk" data-result="tasks_result">
<?php
	$pagination = $tasks_vk['pagination'];
