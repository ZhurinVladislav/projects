            ...
            <nav class="footer-top__menu">
                <ul class="footer-top__menu-list footer-menu-list">
                    <li class="footer-menu-list__item">
                        <a
                            class="footer-menu-list__item-link<?= $current_page == 'main' ? ' active' : '' ?>"
                            href="./main"
                    ...
                    <li class="footer-menu-list__item">
                        <a
                            class="footer-menu-list__item-link<?= $current_page == 'rating' ? ' active' : '' ?>"
                            href="./rating"
                            aria-label="Перейти на страницу рейтинга">
                            Рейтинг
                        </a>
                    ...
                    <li class="footer-menu-list__item">
                        <a
                            class="footer-menu-list__item-link<?= $current_page == 'about-us' ? ' active' : '' ?>"
                            href="./about-us"
                    ...
                    <li class="footer-menu-list__item">
                        <a
                            class="footer-menu-list__item-link<?= $current_page == 'news' ? ' active' : '' ?>"
                            href="./news"
                    ...
                    <li class="footer-menu-list__item">
                        <a
                            class="footer-menu-list__item-link<?= $current_page == 'methodology' ? ' active' : '' ?>"
                            href="./methodology"
...
<button
    id="scroll-top"
    class="home-page__scroll-top scroll-top"
...
<!-- <script src="./app/js/index.min.js?_v=<?= time(); ?>"></script> -->
<script src="./app/js/index.js?a_v=<?= time(); ?>"></script>
<script src="./app/js/main.js?_v=<?= time(); ?>"></script>
</body>
