...
//           </div>
//           <Button type="button" onClick={addWorkday} className="flex items-center gap-2">
//             <Plus size={16} />
//             Добавить день
//           </Button>
//         </div>
...
//               <input
//                 type="text"
//                 placeholder="День недели (пн-пт, сб, вс)"
//                 value={workday.day || ''}
//                 onChange={e => updateWorkday(index, 'day', e.target.value)}
...
//               <Button type="button" variant="danger" onClick={() => removeWorkday(index)} className="flex items-center gap-1">
//                 <X size={14} />
//               </Button>
//             </motion.div>
//           ))}
...
//               <input
//                 type="text"
//                 placeholder="Платформа (VK, Telegram, Instagram)"
...
//                 className="flex-1 rounded border border-(--secondary-color) p-2 text-sm"
//               />
//               <Button type="button" variant="danger" onClick={() => removeSocial(index)} className="flex items-center gap-1">
//                 <X size={14} />
//               </Button>
//             </motion.div>
//           ))}
...
//               <input
//                 type="text"
//                 placeholder="Название сервиса (2GIS, Яндекс.Карты)"
//                 value={link.serviceName || ''}
//                 onChange={e => updateServiceLink(index, 'serviceName', e.target.value)}
//                 className="flex-1 rounded border border-(--secondary-color) p-2 text-sm"
//               />
//               <input
//                 type="url"
...
//                 className="flex-1 rounded border border-(--secondary-color) p-2 text-sm"
//               />
//               <Button type="button" variant="danger" onClick={() => removeServiceLink(index)} className="flex items-center gap-1">
//                 <X size={14} />
//               </Button>
//             </motion.div>
//           ))}
