...
if ($_POST['action'] != 'get_page') {
	if ($_POST['action'] == 'add') {
		...
		if (news_add_item($title_ru, $title_en, $title_de, $title_pt, $title_es, $title_fr, $title_hi, $title_id, $title_th, $title_tr, $title_zh, $annotation_ru, $annotation_en, $annotation_de, $annotation_pt, $annotation_es, $annotation_fr, $annotation_hi, $annotation_id, $annotation_th, $annotation_tr, $annotation_zh, $content_ru, $content_en, $content_de, $content_pt, $content_es, $content_fr, $content_hi, $content_id, $content_th, $content_tr, $content_zh, $image, $admin_only)) {
