...
require_once  $_SERVER['DOCUMENT_ROOT'] . '/functions/isUserReview.php';
...
$id = $companyObj->getCompanyByPageId($page_id)['id'];

$company = $companyObj->get($id);
$phones = $companyObj->getPhones($id);
$links = $companyObj->getLinks($id);
...
$category = $companyObj->getCompanyCategoryById($id);
            ...
            <ul class="breadcrumb__list breadcrumb-list">
                ...
                <li class="breadcrumb-list__item">
                    <a
                        ...
                        href="<?= htmlspecialchars($category['alias']); ?>">
                        <?= htmlspecialchars($category['category_name']); ?> в Краснодарском крае
                    </a>
                </li>
                <li class="breadcrumb-list__item">
                    <span
                        ...
                        <li class="text-list__item text-info">
                            ...
                            <div class="text-info__more">
                                <p class="text-info__more-descr">
                                    ...
                                    <?php if (!empty($company['link_map'])): ?>
                                        <a
                                            class="text-info__more-link"
                                            href="<?= htmlspecialchars($company['link_map']) ?>"
                                            target="_blank">
                                            Смотреть на карте
                                        </a>
                                    <?php endif ?>
                        ...
                        <?php foreach ($links as $link): ?>
                            <li class="text-list__item text-info">
                                <a
                                    ...
                                    target="_blank"
                                    aria-label="Перейти на страницу в <?= htmlspecialchars($link['text']); ?>">
                                    <?php if ($link['type'] === 'vk'): ?>
                                        <svg class="text-link__icon">
                                            <use
                                                href="./app/img/icons/icons.svg#vk"></use>
                                        </svg>
                                    <?php elseif ($link['type'] === 'tg'): ?>
                                        <svg class="text-link__icon">
                                            <use
                                                href="./app/img/icons/icons.svg#tg"></use>
                                        </svg>
                                    <?php elseif ($link['type'] === 'wa'): ?>
                                        <svg class="text-link__icon">
                                            <use
                                                href="./app/img/icons/icons.svg#wa"></use>
                                        </svg>
                                    <?php elseif ($link['type'] === 'inst'): ?>
                                        <svg class="text-link__icon">
                                            <use
                                                href="./app/img/icons/icons.svg#inst"></use>
                                        </svg>
                                    <?php elseif ($link['type'] === 'ok'): ?>
                                        <svg class="text-link__icon">
                                            <use
                                                href="./app/img/icons/icons.svg#ok"></use>
                                        </svg>
                                    <?php elseif ($link['type'] === 'yt'): ?>
                                        <svg class="text-link__icon">
                                            <use
